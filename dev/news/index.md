...
- [`make_asset()`](https://gilead-public.github.io/gsm.utils/dev/reference/make_asset.md)
  is a new generic function for creating pkgdown menu asset files.
  [`make_slides()`](https://gilead-public.github.io/gsm.utils/dev/reference/make_slides.md)
  is a new function for creating RevealJS slide deck templates
  ([\#136](https://github.com/Gilead-Public/gsm.utils/issues/136)).
...
- We now use the `fs` package for file manipulation
  ([\#25](https://github.com/Gilead-Public/gsm.utils/issues/25)).
- Actions have been standardized for gsm repos
  ([\#28](https://github.com/Gilead-Public/gsm.utils/issues/28),
  [\#31](https://github.com/Gilead-Public/gsm.utils/issues/31),
  [\#35](https://github.com/Gilead-Public/gsm.utils/issues/35),
  [\#40](https://github.com/Gilead-Public/gsm.utils/issues/40),
  [\#44](https://github.com/Gilead-Public/gsm.utils/issues/44),
  [\#45](https://github.com/Gilead-Public/gsm.utils/issues/45),
  [\#66](https://github.com/Gilead-Public/gsm.utils/issues/66),
  [\#67](https://github.com/Gilead-Public/gsm.utils/issues/67),
  [\#71](https://github.com/Gilead-Public/gsm.utils/issues/71),
  [\#73](https://github.com/Gilead-Public/gsm.utils/issues/73),
  [\#74](https://github.com/Gilead-Public/gsm.utils/issues/74),
  [\#75](https://github.com/Gilead-Public/gsm.utils/issues/75),
  [\#76](https://github.com/Gilead-Public/gsm.utils/issues/76),
  [\#77](https://github.com/Gilead-Public/gsm.utils/issues/77),
  [\#78](https://github.com/Gilead-Public/gsm.utils/issues/78),
  [\#90](https://github.com/Gilead-Public/gsm.utils/issues/90),
  [\#97](https://github.com/Gilead-Public/gsm.utils/issues/97),
  [\#106](https://github.com/Gilead-Public/gsm.utils/issues/106),
  [\#107](https://github.com/Gilead-Public/gsm.utils/issues/107),
  [\#114](https://github.com/Gilead-Public/gsm.utils/issues/114),
  [\#118](https://github.com/Gilead-Public/gsm.utils/issues/118)).
- New function
  ...
  [`vignette("pkgdown-assets")`](https://gilead-public.github.io/gsm.utils/dev/articles/pkgdown-assets.md)
  for details
  ([\#67](https://github.com/Gilead-Public/gsm.utils/issues/67),
  [\#89](https://github.com/Gilead-Public/gsm.utils/issues/89),
  [\#103](https://github.com/Gilead-Public/gsm.utils/issues/103),
  [\#108](https://github.com/Gilead-Public/gsm.utils/issues/108)).
- [`init_gsm_package()`](https://gilead-public.github.io/gsm.utils/dev/reference/init_gsm_package.md)
  and
  ...
  ([\#100](https://github.com/Gilead-Public/gsm.utils/issues/100)).
- [`init_gsm_package()`](https://gilead-public.github.io/gsm.utils/dev/reference/init_gsm_package.md)
  and
  [`update_gsm_package()`](https://gilead-public.github.io/gsm.utils/dev/reference/update_gsm_package.md)
  shared underlying functionality to avoid surprises
  ([\#110](https://github.com/Gilead-Public/gsm.utils/issues/110)).
- Unused experimental functionality has been removed
  ([\#111](https://github.com/Gilead-Public/gsm.utils/issues/111)).
...
- Refactored utility functions for package and template management:
  ...
  `add_gsm_actions()`,
  [`add_contributor_guidelines()`](https://gilead-public.github.io/gsm.utils/dev/reference/add_contributor_guidelines.md),
  `add_pkgdown_examples()`.
- Added versioning system for GitHub Actions templates\*\*
  ([\#36](https://github.com/Gilead-Public/gsm.utils/issues/36)):
