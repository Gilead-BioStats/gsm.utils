...
- **`pkgdown-all.yaml`**: Builds and deploys pkgdown documentation sites
  ...
  [`gsm.utils::build_assets()`](https://gilead-biostats.github.io/gsm.utils/reference/build_assets.md).
...
- **`test-coverage.yaml`**: Computes test coverage using `covr` and logs
  ...
  (written via
  [`gsm.utils::emit_coverage_summary()`](https://gilead-biostats.github.io/gsm.utils/reference/emit_coverage_summary.md))
